...
function initChart() {
  ...
  return new Chart(ctx, {
    type: 'bar',
    data: {
      labels: ['Usuarios Totales', 'Descargas Mensuales'],
      datasets: [{
        label: 'Valores',
        data: [0, 0],
        backgroundColor: [
...
async function fetchStatistics() {
  try {
    ...
    document.getElementById('total-documents').textContent = data.total_documents?.toLocaleString() ?? '0';
    document.getElementById('total-users').textContent = data.total_users?.toLocaleString() ?? '0';
    document.getElementById('monthly-downloads').textContent = data.monthly_downloads?.toLocaleString() ?? '0';
